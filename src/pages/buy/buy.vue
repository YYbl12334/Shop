<template>
	...
	<view class="tab-strickt" >
		<u-tabs :list="tabList" :is-scroll="true" active-color="#FF7670" inactive-color="#606266" font-size="30"
			v-model="current" count="cate_count" @change="chang" name="cate_name"></u-tabs>
	</view>
